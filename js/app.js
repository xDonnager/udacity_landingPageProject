...
if (browserSupport.events && browserSupport.selectors) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const listElements = createListElements(appSelectors.sections);
    createNavigationMenu(listElements, appSelectors.navbarList);
  ...
  alert("Some features may not be available due to browser compatibility");
}
